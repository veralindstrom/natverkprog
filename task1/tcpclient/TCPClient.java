...
public class TCPClient {
    public static String askServer(String hostname, int port, String ToServer) throws IOException {
        byte[] fromUserBuffer = ToServer.getBytes(StandardCharsets.UTF_8); // encoded user bytes
        ...
        try {
            ...
            for(int i = clientSocket.getInputStream().read(fromServerBuffer); i != -1; i = clientSocket.getInputStream().read(fromServerBuffer)){
